...
# NOTE: upstream 原样 (RAVEN: project/models/reward_models/vbench_dino/vision_transformer.py:25);
# MFU instrumentation (project.utils.mfu) is not ported to this repo, so the import is removed
# and the CustomFlops mixin below is dropped from the class bases.
...
# NOTE: upstream 原样 (RAVEN: project/models/reward_models/vbench_dino/vision_transformer.py:69);
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.qk_matmul = MatmulForward()
        self.av_matmul = MatmulForward()
